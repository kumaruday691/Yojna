...
public class Readmail1 extends Fragment {
	...
	public class CardArrayAdapter extends ArrayAdapter<Card> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			viewHolder.line0.setText("< PACKAGE " + position + " > ");
			viewHolder.line1.setText("Estimated Time For Arrival");
			viewHolder.line2.setText("Vendor Website Link");
			return row;
		}
